...
export const Header = () => {
  ...
  const handleSubmit = (event) => {
    ...
    event.target.reset();
    // If the queryTerm is empty, we don't want to navigate anywhere.
    //navigate is a function from react-router-dom that allows us to navigate programmatically to a different route.
